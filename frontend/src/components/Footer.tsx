    ...
    <footer className="bg-primary/5 border-t border-border py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="#security" className="text-muted-foreground hover:text-accent transition-colors">
                  Security
                </Link>
              </li>
              <li>
                <Link to="#gdpr" className="text-muted-foreground hover:text-accent transition-colors">
                  GDPR
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            © 2025 SkillSense. All rights reserved.
          </p>
